  ...
  return (
    <div className="p-4 md:p-6 max-w-2xl space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        <a href="https://t.me" target="_blank" rel="noreferrer" className="bg-card border rounded-xl p-4 flex items-center gap-3 hover:shadow-elevated transition shadow-card">
          <Send className="text-primary" /><div><div className="font-bold">Telegram</div><div className="text-xs text-muted-foreground">@rsanimelink</div></div>
        </a>
